...
const FAQS = [
  ...
  { q: 'Do you handle paid ads?', a: 'Yes — Google and Meta primarily, paid social where it converts. Ad management is 20% of spend. No minimums; you pay for what we run. Every Bespoke engagement includes a forensic ad account audit that finds hidden waste most agencies miss.' },
