...
export function IconArrow({ size = 13, stroke = 1.6 }) {
  return (
...
export function IconArrowSmall({ size = 11, stroke = 1.4 }) {
  return (
...
export function IconClose({ size = 16, stroke = 1.8 }) {
  return (
...
export function IconCheck({ size = 10, stroke = 1.8 }) {
  return (
...
export function IconBack({ size = 14, stroke = 1.6 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 14 14" fill="none">
...
export function IconPlus({ size = 13, stroke = 1.6 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 14 14" fill="none">
...
export function IconTick({ size = 15, stroke = 1.6 }) {
  return (
