...
const TIERS_DATA = [
  {
    ...
    tagline: 'A hand-built, high-converting Framer website with managed hosting — the foundation everything else is built on.',
    best: 'For operators who need a beautiful, fast site that actually converts, maintained and optimised by us.',
    features: [
      'Custom Framer site, built to your vision',
  ...
  },
  {
    ...
    tagline: 'The full marketing platform, AI agent stack, and automation suite — managed by you, powered by us.',
    best: 'For founders who want the controls — with our platform, agents, and automations underneath.',
    features: [
      'CRM, pipeline & appointment booking',
      'Email · SMS · social automation 24/7',
      'Conversation AI, Voice AI, Content AI, Reviews AI',
      'Workflow automation builder',
      'Real-time client dashboard & reporting',
  ...
  },
  {
    ...
    tagline: 'A fully-managed growth system. Strategy, execution, optimisation, and a bespoke site — all handled.',
    best: 'For operators who want a senior team running the entire engine. You stay in your zone of genius.',
    features: [
      ...
      'Monthly strategy calls & deep reporting',
    ],
